...
async function loadState() {
    const features = ["feature_player", "feature_copy_title", "feature_shiki_buttons", "feature_yanima_buttons", "feature_display_id", "feature_mal_rating", "feature_search_links", "feature_hevc_filter"];
